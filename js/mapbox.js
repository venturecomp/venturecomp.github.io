(function(f) {
    ...
    return (function e(t, n, r) {
            ...
            var Bucket = require("../bucket"),
                ...
                CircleBucket = function(e) {
                    ...
                    return e && (r.__proto__ = e), r.prototype = Object.create(e && e.prototype), r.prototype.constructor = r, r.prototype.addFeature = function(e) {
                        for (var r = this.arrays, t = 0, a = loadGeometry(e); t < a.length; t += 1)
                            for (var c = a[t], p = 0, i = c; p < i.length; p += 1) {
                                var l = i[p],
                                    y = l.x,
                                    o = l.y;
        ...
        47: [function(require, module, exports) {
            ...
            var Bucket = require("../bucket"),
                ...
                FillBucket = function(e) {
                    ...
                    return e && (r.__proto__ = e), r.prototype = Object.create(e && e.prototype), r.prototype.constructor = r, r.prototype.addFeature = function(e) {
                        for (var r = this.arrays, t = 0, a = classifyRings(loadGeometry(e), EARCUT_MAX_RINGS); t < a.length; t += 1) {
                            for (var l = a[t], p = 0, n = 0, y = l; n < y.length; n += 1) {
                                var i = y[n];
                                p += i.length
                            }
                            for (var o = r.prepareSegment(p), c = o.vertexLength, u = [], g = [], h = 0, m = l; h < m.length; h += 1) {
                                var s = m[h];
                                if (0 !== s.length) {
                                    s !== l[0] && g.push(u.length / 2);
                                    var f = r.prepareSegment2(s.length),
                                        A = f.vertexLength;
                            ...
                            for (var x = earcut(u, g), _ = 0; _ < x.length; _ += 3) r.elementArray.emplaceBack(c + x[_], c + x[_ + 1], c + x[_ + 2]);
                ...
                FillExtrusionBucket = function(e) {
                    ...
                    return e && (r.__proto__ = e), r.prototype = Object.create(e && e.prototype), r.prototype.constructor = r, r.prototype.addFeature = function(e) {
                        for (var r = this.arrays, t = 0, a = classifyRings(loadGeometry(e), EARCUT_MAX_RINGS); t < a.length; t += 1) {
                            ...
                            for (var p = r.prepareSegment(5 * o), u = [], c = [], x = [], s = 0, f = n; s < f.length; s += 1) {
                                var d = f[s];
                                if (0 !== d.length) {
                            ...
                            for (var E = earcut(u, c), T = 0; T < E.length; T += 3) r.elementArray.emplaceBack(x[E[T]], x[E[T + 1]], x[E[T + 2]]);
                        ...
                        if (!(l < (u ? 3 : 2))) {
                            ...
                            for (var V = 0; V < l; V++)
                                if (m = u && V === l - 1 ? e[1] : e[V + 1], !m || !e[V].equals(m)) {
                                    ...
                                    var g = h && m,
                                        F = g ? r : m ? A : f;
                                    if (g && "round" === F && (I < n ? F = "miter" : I <= 2 && (F = "fakeround")), "miter" === F && I > a && (F = "bevel"), "bevel" === F && (I > 2 && (F = "flipbevel"), I < a && (F = "miter")), h && (d.distance += y.dist(h)), "miter" === F) S._mult(I), d.addCurrentVertex(y, d.distance, S, 0, 0, !1, _);
                                    else if ("flipbevel" === F) {
                                        if (I > 100) S = x.clone().mult(-1);
                                        else {
                                        ...
                                        if (D ? (v = 0, C = P) : (C = 0, v = P), L || d.addCurrentVertex(y, d.distance, E, C, v, !1, _), "fakeround" === F) {
                                            for (var U = Math.floor(8 * (.5 - (T - .5))), q = void 0, M = 0; M < U; M++) q = x.mult((M + 1) / (U + 1))._add(E)._unit(), d.addPieSliceVertex(y, d.distance, q, D, _);
        ...
        50: [function(require, module, exports) {
            ...
            var Point = require("point-geometry"),
                ArrayGroup = require("../array_group"),
                BufferGroup = require("../buffer_group"),
                createVertexArrayType = require("../vertex_array_type"),
                createElementArrayType = require("../element_array_type"),
                EXTENT = require("../extent"),
            ...
            SymbolBucket.prototype.populate = function(e, t) {
                var o = this,
                    ...
                    i = a["text-font"],
                    n = a["icon-image"],
                    l = i && (!r.isLayoutValueFeatureConstant("text-field") || a["text-field"]),
                    s = n;
                if (this.features = [], l || s) {
                    for (var c = t.iconDependencies, y = t.glyphDependencies, p = y[i] = y[i] || {}, x = 0; x < e.length; x++) {
                        var h = e[x];
                        if (r.filter(h)) {
                            var u = void 0;
                            l && (u = resolveText(r, {
                                zoom: o.zoom
                            }, h.properties), rtlTextPlugin.applyArabicShaping && (u = rtlTextPlugin.applyArabicShaping(u)));
                            var d = void 0;
                            if (s && (d = resolveTokens(h.properties, n)), (u || d) && (o.features.push({
                                ...
                                for (var m = 0; m < u.length; m++) p[u.charCodeAt(m)] = !0
                        }
                    }
                ...
                var o = this;
                this.symbolInstances = [], this.adjustedTextMaxSize = this.layers[0].getLayoutValue("text-size", {
                    zoom: 18
                }), this.adjustedTextSize = this.layers[0].getLayoutValue("text-size", {
                    zoom: this.zoom + 1
                }), this.adjustedIconMaxSize = this.layers[0].getLayoutValue("icon-size", {
                    zoom: 18
                }), this.adjustedIconSize = this.layers[0].getLayoutValue("icon-size", {
                    zoom: this.zoom + 1
                });
                ...
                for (var l = "right" === a["text-justify"] ? 1 : "left" === a["text-justify"] ? 0 : .5, s = 24, c = a["text-line-height"] * s, y = "line" !== a["symbol-placement"] ? a["text-max-width"] * s : 0, p = a["text-letter-spacing"] * s, x = [a["text-offset"][0] * s, a["text-offset"][1] * s], h = this.fontstack = a["text-font"].join(","), u = "map" === a["text-rotation-alignment"] && "line" === a["symbol-placement"], d = 0, m = o.features; d < m.length; d += 1) {
                    ...
                    if (g.icon) {
                        var I = t[g.icon],
                            S = o.layers[0].getLayoutValue("icon-offset", {
                                zoom: o.zoom
                            }, g.properties);
                ...
                var r = this,
                    a = this.layers[0].layout,
                    i = 24,
                    n = this.adjustedTextSize / i,
                    l = void 0 !== this.adjustedTextMaxSize ? this.adjustedTextMaxSize : this.adjustedTextSize,
                    s = this.tilePixelRatio * n,
                    c = this.tilePixelRatio * l / i,
                    y = this.tilePixelRatio * this.adjustedIconSize,
                    p = this.tilePixelRatio * a["symbol-spacing"],
                    x = a["symbol-avoid-edges"],
                    h = a["text-padding"] * this.tilePixelRatio,
                    u = a["icon-padding"] * this.tilePixelRatio,
                    ...
                    b = a["symbol-placement"],
                    v = p / 2,
                    I = function(a, i) {
                        var n = !(i.x < 0 || i.x > EXTENT || i.y < 0 || i.y > EXTENT);
                        if (!x || n) {
                            var l = n || f;
                            r.addSymbolInstance(i, a, t, o, r.layers[0], l, r.collisionBoxArray, e.index, e.sourceLayerIndex, r.index, s, h, m, y, u, g, {
                                zoom: r.zoom
                            }, e.properties)
                        }
                    };
                if ("line" === b)
                    for (var S = 0, T = clipLine(e.geometry, 0, 0, EXTENT, EXTENT); S < T.length; S += 1)
                        for (var M = T[S], B = getAnchors(M, p, d, t[WritingMode.vertical] || t[WritingMode.horizontal], o, i, c, r.overscaling, EXTENT), A = 0, z = B; A < z.length; A += 1) {
                            var _ = z[A],
                                E = t[WritingMode.horizontal];
                            E && r.anchorIsTooClose(E.text, v, _) || I(M, _)
                        } else if ("Polygon" === e.type)
                            for (var k = 0, P = classifyRings(e.geometry, 0); k < P.length; k += 1) {
                                var w = P[k],
                                    L = findPoleOfInaccessibility(w, 16);
                                I(w[0], new Anchor(L.x, L.y, 0))
                            } else if ("LineString" === e.type)
                                for (var V = 0, C = e.geometry; V < C.length; V += 1) {
                                    var N = C[V];
                                    I(N, new Anchor(N[0].x, N[0].y, 0))
                                } else if ("Point" === e.type)
                                    for (var j = 0, q = e.geometry; j < q.length; j += 1)
                                        for (var F = q[j], W = 0, Q = F; W < Q.length; W += 1) {
                                            var U = Q[W];
                ...
                if (l) {
                    ...
                    this.symbolInstances.sort(function(e, t) {
                        var o = c * e.anchor.x + y * e.anchor.y | 0,
                            r = c * t.anchor.x + y * t.anchor.y | 0;
                ...
                for (var p = 0, x = o.symbolInstances; p < x.length; p += 1) {
                    var h = x[p],
                        ...
                        g = !(h.iconBoxStartIndex === h.iconBoxEndIndex),
                        f = r["text-optional"] || !m,
                        b = r["icon-optional"] || !g,
                ...
                for (var s = e.elementArray, c = e.layoutVertexArray, y = this.zoom, p = Math.max(Math.log(o) / Math.LN2 + y, 0), x = 0, h = t; x < h.length; x += 1) {
                    var u = h[x],
                        d = (u.anchorAngle + i + Math.PI) % (2 * Math.PI);
                    ...
                    if (!(T <= S)) {
                        S === p && (S = 0);
                        var M = Math.round(u.glyphAngle / (2 * Math.PI) * 256),
                            B = e.prepareSegment(4),
                            A = B.vertexLength;
                ...
                for (var t = this, o = this.arrays.collisionBox, r = o.layoutVertexArray, a = o.elementArray, i = -e.angle, n = e.yStretch, l = 0, s = t.symbolInstances; l < s.length; l += 1) {
                    var c = s[l];
                    ...
                    for (var y = 0; y < 2; y++) {
                        ...
                        if (p)
                            for (var x = p.boxStartIndex; x < p.boxEndIndex; x++) {
                                var h = t.collisionBoxArray.get(x),
                                    u = h.anchorPoint,
                                    d = new Point(h.x1, h.y1 * n)._rotate(i),
                                    m = new Point(h.x2, h.y1 * n)._rotate(i),
                                    g = new Point(h.x1, h.y2 * n)._rotate(i),
                                    f = new Point(h.x2, h.y2 * n)._rotate(i),
        ...
        52: [function(require, module, exports) {
            ...
            var util = require("../util/util"),
                ...
                BufferGroup = function(e, r, t, a) {
                    ...
                    for (var n = 0, u = r; n < u.length; n += 1) {
                        var i = u[n],
                            s = a.paintVertexArrays && a.paintVertexArrays[i.id],
                    ...
                    for (var l = 0, m = [f.segments, f.segments2]; l < m.length; l += 1)
                        for (var B = m[l], p = 0, g = B || []; p < g.length; p += 1) {
                            var h = g[p];
            ...
            BufferGroup.prototype.destroy = function() {
                ...
                for (var a = 0, f = [e.segments, e.segments2]; a < f.length; a += 1)
                    for (var n = f[a], u = 0, i = n || []; u < i.length; u += 1) {
                        var s = i[u];
        ...
        55: [function(require, module, exports) {
            ...
            var Point = require("point-geometry"),
                ...
                createStructArrayType = require("../util/struct_array"),
                                ...
                                for (var x = null, P = 0; P < d.length; P++) {
                                    ...
                                    if (!(n && n.indexOf(I) < 0)) {
                                        ...
                                        if (m) {
                                            var L = void 0;
                                            if ("symbol" !== m.type)
                                                if (x || (x = loadGeometry(v)), "line" === m.type) {
        ...
        58: [function(require, module, exports) {
            ...
            ProgramConfiguration.createDynamic = function(t, r, e) {
                ...
                for (var o = 0, p = e.getPaintValueStopZoomLevels(r.property); o < p.length && p[o] < i;) o++;
                var u = Math.max(0, Math.min(p.length - 4, o - 2)),
                    s = "u_" + t + "_t";
                ...
                if (1 === r.components) this.attributes.push(util.extend({}, r, {
                    components: 4,
                    zoomStops: m
                })), n.vertex.define.push("attribute {precision} vec4 " + r.name + ";"), g.push(r.name);
                else
                    for (var h = 0; h < 4; h++) {
                        var l = r.name + h;
        ...
        71: [function(require, module, exports) {
            ...
            function drawExtrusion(t, e, r, i) {
                if (!t.isOpaquePass) {
                    ...
                    if (s) {
                        var u = s.buffers,
                            f = t.gl,
                            h = r.paint["fill-extrusion-pattern"],
                            n = u.layerData[r.id],
                            o = n.programConfiguration,
                            E = t.useProgram(h ? "fillExtrusionPattern" : "fillExtrusion", o);
                        o.setUniforms(f, E, r, {
                            zoom: t.transform.zoom
                        }), h && (pattern.prepare(h, t, E), pattern.setTile(a, t, E), f.uniform1f(E.u_height_factor, -Math.pow(2, i.z) / a.tileSize / 8)), t.gl.uniformMatrix4fv(E.u_matrix, !1, t.translatePosMatrix(i.posMatrix, a, r.paint["fill-extrusion-translate"], r.paint["fill-extrusion-translate-anchor"])), setLight(E, t);
            ...
            module.exports = draw, ExtrusionTexture.prototype.bindFramebuffer = function() {
                var t = this.gl;
                if (this.texture = this.painter.getViewportTexture(this.width, this.height), t.activeTexture(t.TEXTURE1), this.texture ? t.bindTexture(t.TEXTURE_2D, this.texture) : (this.texture = t.createTexture(), t.bindTexture(t.TEXTURE_2D, this.texture), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_S, t.CLAMP_TO_EDGE), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_WRAP_T, t.CLAMP_TO_EDGE), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MIN_FILTER, t.LINEAR), t.texParameteri(t.TEXTURE_2D, t.TEXTURE_MAG_FILTER, t.LINEAR), t.texImage2D(t.TEXTURE_2D, 0, t.RGBA, this.width, this.height, 0, t.RGBA, t.UNSIGNED_BYTE, null), this.texture.width = this.width, this.texture.height = this.height), this.fbos) this.fbo = this.fbos.pop(), t.bindFramebuffer(t.FRAMEBUFFER, this.fbo), t.framebufferTexture2D(t.FRAMEBUFFER, t.COLOR_ATTACHMENT0, t.TEXTURE_2D, this.texture, 0);
                else {
                        ...
                        for (var n, o = t.paint["line-dasharray"] ? "lineSDF" : t.paint["line-pattern"] ? "linePattern" : "line", f = !0, s = 0, l = r; s < l.length; s += 1) {
                            ...
                            if (_) {
                                ...
                                v && p.programConfiguration.setUniforms(e.gl, d, t, {
                                    zoom: e.transform.zoom
                                }), drawLineTile(d, e, m, _.buffers, t, u, p, v, T), n = m.coord.z, f = !1
                            }
                        }
                }
            };
        ...
        74: [function(require, module, exports) {
                    ...
                    for (var d, _, h = 0, g = i; h < g.length; h += 1) {
                        ...
                        if (b) {
                            ...
                            if (x && x.segments.length) {
                                var S = x.layerData[a.id],
                                    w = S.programConfiguration,
                                    v = o || b.sdfIcons;
                                d && b.fontstack === _ || (d = e.useProgram(v ? "symbolSDF" : "symbolIcon", w), w.setUniforms(f, d, a, {
                                    zoom: e.transform.zoom
                                }), setSymbolDrawState(d, e, o, v, m, p, b.fontstack, u, b.iconsNeedLinear, o ? b.adjustedTextSize : b.adjustedIconSize)), e.enableTileClippingMask(y), f.uniformMatrix4fv(d.u_matrix, !1, e.translatePosMatrix(y.posMatrix, T, r, n)), drawTileSymbols(d, e, a, T, x, o, v, p, u), _ = b.fontstack
                            }
                        }
                    }
            ...
            function drawSymbolElements(e, t, a, i) {
                for (var o = e.layerData[t.id], r = o && o.paintVertexBuffer, n = 0, l = e.segments; n < l.length; n += 1) {
                    var s = l[n];
        ...
        80: [function(require, module, exports) {
            ...
            VertexArrayObject.prototype.bind = function(e, t, r, i, n, o) {
                ...
                if (e.extVertexArrayObject) this.vao && this.destroy(), this.vao = e.extVertexArrayObject.createVertexArrayOES(), e.extVertexArrayObject.bindVertexArrayOES(this.vao), s = 0, this.boundProgram = t, this.boundVertexBuffer = r, this.boundVertexBuffer2 = n, this.boundElementBuffer = i, this.boundVertexOffset = o;
                else {
            ...
            VectorTileWorkerSource.prototype.loadTile = function(e, r) {
                function t(e, t) {
                    return delete this.loading[o][i], e ? r(e) : t ? (a.vectorTile = t, a.parse(t, this.layerIndex, this.actor, function(e, o, i) {
                        if (e) return r(e);
                        var a = {};
                        t.expires && (a.expires = t.expires), t.cacheControl && (a.cacheControl = t.cacheControl), r(null, util.extend({
        ...
        98: [function(require, module, exports) {
            ...
            var Actor = require("../util/actor"),
                StyleLayerIndex = require("../style/style_layer_index"),
                VectorTileWorkerSource = require("./vector_tile_worker_source"),
                GeoJSONWorkerSource = require("./geojson_worker_source"),
                globalRTLTextPlugin = require("./rtl_text_plugin"),
                Worker = function(e) {
                    var r = this;
        ...
        105: [function(require, module, exports) {
            ...
            var colorSpaces = require("./color_spaces"),
                parseColor = require("../util/parse_color"),
        ...
        114: [function(require, module, exports) {
            ...
            "lodash._baseisequal": 109,
            "lodash._bindcallback": 110
        }],
        ...
        142: [function(require, module, exports) {
            ...
            var validateConstants = require("./validate/validate_constants"),
                ...
                latestStyleSpec = require("./reference/latest"),
                ...
                ImageSprite = function(t) {
                    function i(i, e) {
                        ...
                        ajax.getJSON(normalizeURL(i, r, ".json"), function(t, i) {
                            return t ? void a.fire("error", {
                                error: t
                            }) : (a.data = i, void(a.imgData && a.fire("data", {
                                dataType: "style"
                            })))
                        }), ajax.getImage(normalizeURL(i, r, ".png"), function(t, i) {
                            if (t) return void a.fire("error", {
                                error: t
                            });
                            ...
                            a.width = i.width, a.data && a.fire("data", {
                                dataType: "style"
                            })
                        })
                    }
        ...
        146: [function(require, module, exports) {
            ...
            var Evented = require("../util/evented"),
                ...
                deref = require("../style-spec/deref"),
                diff = require("../style-spec/diff"),
                rtlTextPlugin = require("../source/rtl_text_plugin"),
            ...
            var util = require("../util/util"),
                ...
                StyleLayer = function(t) {
                    ...
                    return t && (i.__proto__ = t), i.prototype = Object.create(t && t.prototype), i.prototype.constructor = i, i.prototype.setLayoutProperty = function(t, i, a) {
                        ...
                        for (var o = this, r = util.extend({}, this._paintDeclarations[""]), s = 0; s < t.length; s++) util.extend(r, o._paintDeclarations[t[s]]);
                        var l;
                        ...
                        var i = this;
                        for (var a in i._paintTransitions) i.paint[a] = i.getPaintValue(a, {
                            zoom: t
                        });
                        for (var e in i._layoutFunctions) i.layout[e] = i.getLayoutValue(e, {
                            zoom: t
                        })
                    }, i.prototype.serialize = function() {
                        var t = this,
        ...
        149: [function(require, module, exports) {
            ...
            var StyleLayer = require("../style_layer"),
                CircleBucket = require("../../data/bucket/circle_bucket"),
        ...
        151: [function(require, module, exports) {
            "use strict";
            var StyleLayer = require("../style_layer"),
                FillBucket = require("../../data/bucket/fill_bucket"),
        ...
        152: [function(require, module, exports) {
            "use strict";
            var StyleLayer = require("../style_layer"),
                LineBucket = require("../../data/bucket/line_bucket"),
                util = require("../../util/util"),
        ...
        153: [function(require, module, exports) {
            "use strict";
            var StyleLayer = require("../style_layer"),
                SymbolBucket = require("../../data/bucket/symbol_bucket"),
        ...
        154: [function(require, module, exports) {
            ...
            var StyleLayer = require("./style_layer"),
                util = require("../util/util"),
                featureFilter = require("../style-spec/feature_filter"),
                groupByLayout = require("../style-spec/group_by_layout"),
        ...
        162: [function(require, module, exports) {
            ...
            var Point = require("point-geometry"),
                EXTENT = require("../data/extent"),
                Grid = require("grid-index"),
                intersectionTests = require("../util/intersection_tests"),
        ...
        167: [function(require, module, exports) {
            ...
            function getIconQuads(t, e, a, n, i, o, l, h, r) {
                var s, g, u, c, m = e.image.rect,
                    f = i.layout,
                    d = 1,
                    x = e.left - d,
                    P = x + m.w / e.image.pixelRatio,
                    y = e.top - d,
                    M = y + m.h / e.image.pixelRatio;
                if ("none" !== f["icon-text-fit"] && l) {
                    var p = P - x,
                        ...
                        Q = b - S,
                        G = _ - I,
                        k = f["icon-text-fit-padding"][0],
                        q = f["icon-text-fit-padding"][1],
                        A = f["icon-text-fit-padding"][2],
                        R = f["icon-text-fit-padding"][3],
            ...
            function getGlyphQuads(t, e, a, n, i, o) {
                for (var l = i.layout["text-rotate"] * Math.PI / 180, h = i.layout["text-keep-upright"], r = e.positionedGlyphs, s = [], g = 0; g < r.length; g++) {
                    var u = r[g],
                        c = u.glyph;
                    if (c) {
                        var m = c.rect;
                        if (m) {
                            var f = (u.x + c.advance / 2) * a,
                                d = void 0,
                                x = minScale;
            ...
            var ShelfPack = require("@mapbox/shelf-pack"),
                ...
                SpriteAtlas = function(t) {
                    ...
                    return t && (i.__proto__ = t), i.prototype = Object.create(t && t.prototype), i.prototype.constructor = i, i.prototype.allocateImage = function(t, i) {
                        ...
                        var r, a, h;
                        if (i instanceof window.HTMLImageElement ? (r = i.width, a = i.height, i = browser.getImageData(i), h = this.pixelRatio) : (r = e.width, a = e.height, h = e.pixelRatio || this.pixelRatio), ArrayBuffer.isView(i) && (i = new Uint32Array(i.buffer)), !(i instanceof Uint32Array)) return this.fire("error", {
                            error: new Error("Image provided in an invalid format. Supported formats are HTMLImageElement, ImageData, and ArrayBufferView.")
                        });
                        ...
                        var i = this.images[t];
                        return delete this.images[t], i ? (this.shelfPack.unref(i.rect), void this.fire("data", {
                            dataType: "style"
                        })) : this.fire("error", {
                ...
                Camera = function(t) {
                    ...
                    return t && (i.__proto__ = t), i.prototype = Object.create(t && t.prototype), i.prototype.constructor = i, i.prototype.getCenter = function() {
                        ...
                        var a = Point.convert(i.offset),
                            h = this.transform,
                            u = h.project(t.getNorthWest()),
                            p = h.project(t.getSouthEast()),
                            c = p.sub(u),
        ...
        173: [function(require, module, exports) {
            ...
            AttributionControl.prototype.getDefaultPosition = function() {
                ...
                if (this._map.style && (!t || "metadata" === t.sourceDataType)) {
                    var i = [],
                        o = this._map.style.sourceCaches;
                    for (var n in o) {
                        var e = o[n].getSource();
                    ...
                    i.sort(function(t, i) {
                        ...
                        for (var n = o + 1; n < i.length; n++)
                            if (i[n].indexOf(t) >= 0) return !1;
                        return !0
        ...
        182: [function(require, module, exports) {
            ...
            DragRotateHandler.prototype.isEnabled = function() {
                ...
                this._ignoreEvent(t) || this.isActive() || (window.document.addEventListener("mousemove", this._onMove), window.document.addEventListener("mouseup", this._onUp), window.addEventListener("blur", this._onUp), this._active = !1, this._inertia = [
                ...
                if (!this._ignoreEvent(t) && (window.document.removeEventListener("mousemove", this._onMove), window.document.removeEventListener("mouseup", this._onUp), window.removeEventListener("blur", this._onUp), this.isActive())) {
                    ...
                    var l = p / (inertiaDeceleration * inertiaLinearity),
                        g = u * p * (l / 2);
        ...
        185: [function(require, module, exports) {
            ...
            TouchZoomRotateHandler.prototype.isEnabled = function() {
                ...
                var l = 1e3 * Math.abs(d / (inertiaDeceleration * inertiaLinearity)),
                    c = a + d * l / 2e3;
                c < 0 && (c = 0), o.easeTo({
                    zoom: c,
                    duration: l,
            ...
            var util = require("../util/util"),
                ...
                Map = function(t) {
                    ...
                    return e.prototype.addControl = function(t, e) {
                        ...
                        return this.style && (this.style.setEventedParent(null), this.style._remove(), this.off("rotate", this.style._redoPlacement), this.off("pitch", this.style._redoPlacement)), t ? (t instanceof Style ? this.style = t : this.style = new Style(t, this), this.style.setEventedParent(this, {
                            style: this.style
                        }), this.on("rotate", this.style._redoPlacement), this.on("pitch", this.style._redoPlacement), this) : (this.style = null, this)
        ...
        191: [function(require, module, exports) {
            ...
            exports.getImage = function(e, t) {
                return exports.getArrayBuffer(e, function(e, n) {
                    ...
                    var a = new window.Blob([new Uint8Array(n.data)], {
                        type: "image/png"
                    });
        ...
        193: [function(require, module, exports) {
            ...
            var WebWorkify = require("webworkify"),
                ...
                workerURL = window.URL.createObjectURL(new WebWorkify(require("../../source/worker"), {
                    bare: !0
                }));
